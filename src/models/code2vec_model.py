...
from encoders import NBoWEncoder, Code2VecEncoder, SelfAttentionEncoder, CBoWEncoder
...
class Code2VecModel(Code2VecModelBase):
    ...
    def get_default_hyperparameters(cls) -> Dict[str, Any]:
        ...
        hypers.update({f'query_{key}': value for key, value in CBoWEncoder.get_default_hyperparameters().items()})
        model_hypers = {
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            query_encoder_type=CBoWEncoder,
            run_name=run_name,
